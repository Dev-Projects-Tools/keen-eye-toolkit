...
export const Route = createFileRoute("/workspace")({
  head: () => ({
    meta: [
      { title: "Workspace — LUMEN forensic" },
      {
        name: "description",
        content:
          "Your LUMEN case overview: analyzed frames, ranked plain-language search results and OSINT signals in one place.",
      },
      { property: "og:title", content: "Workspace — LUMEN forensic" },
      {
        property: "og:description",
        content: "Case overview with analyzed frames, ranked search and OSINT signals.",
      },
    ],
  }),
  component: Overview,
